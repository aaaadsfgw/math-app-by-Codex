...
document.querySelector('#clearAllDataButton').addEventListener('click', async () => { if (!confirm('履歴・設定を含む全データを削除しますか？この操作は取り消せません。')) return; await clearAllData(); fill(DEFAULT_SETTINGS); show('全データを削除し、設定を初期値へ戻しました。'); });
