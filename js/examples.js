...
const examples = [
  ...
  ['分数不等式', '(x^2-1)/(x-1)≥0', true],
  ['指数', '2^x = 16 を解け', true], ['対数', 'log_2(x)=3', true], ['三角関数', 'sin 30° を求めよ', false],
  ['微分', 'y=x^3-2x を微分せよ', true], ['不定積分', '∫(2x+1)dx を求めよ', true],
  ['定積分', '∫_0^1 x^2 dx', true],
  ['指数関数の定積分', '∫_0^1 2exp(2x+1) dx', true],
  ['三角関数の定積分', '∫_0^1 sin(x) dx', true],
  ['pi境界の定積分', '∫_0^(pi/4) cos(x) dx', true],
  ['pi傾斜の定積分', '∫_0^1 sin(pi*x) dx', true],
